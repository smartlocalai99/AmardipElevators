  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-xl transition-colors duration-300 hover:bg-[#20bd5a]"
      >
        <FaWhatsapp size={28} />
      </a>
      ...
      <a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#E10600] text-white shadow-xl transition-colors duration-300 hover:bg-[#c90500]"
      >
        <FaPhoneAlt size={22} />
      </a>
    </div>
