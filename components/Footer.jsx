        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-12 lg:gap-16">
            ...
            <div className="flex flex-col items-center text-center xl:items-start xl:text-left gap-6">
              ...
              <Link
                href="/"
                className="flex items-center justify-center rounded-2xl bg-white py-3 xl:justify-start"
              >
                <Image
                  src={Logo_Footer}
                ...
                <div className="flex flex-col justify-center pl-3 md:pl-4">
                  <span className="text-xl md:text-2xl font-semibold tracking-[0.08em] text-black">
                    Amardip
                  </span>

                  <span className="text-xs md:text-sm uppercase tracking-[0.32em] text-black">
                    Elevators
                  </span>
                </div>
              </Link>
