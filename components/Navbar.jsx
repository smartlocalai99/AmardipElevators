                        ...
                        <div className="flex h-16 items-center justify-between px-4 sm:px-6">
                            ...
                            >
                                ...
                                <div className="min-w-0 leading-tight">
                                    <p className="truncate text-sm font-bold tracking-tight text-black sm:text-base">
                                        Amardip
                                    </p>
                                    <p className="truncate text-[10px] font-semibold uppercase tracking-wider text-black sm:text-xs">
                                        Elevators
                                    </p>
                                </div>
                            </Link>
                            ...
                            <nav className="hidden items-center gap-6 text-sm font-semibold text-black/80 md:flex lg:gap-8">
                                ...
                                <Link href="/services/home-elevators" prefetch={false} className="transition hover:text-red-600">
                                    Services
                                </Link>
