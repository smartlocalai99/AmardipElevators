  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`https://amardipelevators.com/blog/${blog.id}`} />
        <meta property="og:title" content={blog.title} />
        <meta property="og:description" content={blog.metaDescription} />
        <meta property="og:url" content={`https://amardipelevators.com/blog/${blog.id}`} />
...
export function getStaticProps({ params }) {
  const blog = BLOGS_DATA.find((item) => item.id === params.blogId);
