...
export default function BlogIndexPage() {
  return (
    <>
      <Head>
        <title>Elevator Insights & Safety Guides | Amardeep Elevators Blog</title>
        <meta name="description" content="Stay updated with lift safety tips, home elevator installation costs, maintenance checklists, and comparisons. Expert guides by Amardeep Elevators." />
        <meta name="keywords" content="elevator blog, lift installation costs, home lifts guide, passenger lift vs capsule lift" />
        <link rel="canonical" href="https://amardipelevators.com/blog" />
      </Head>
      <Navbar />
              ...
              >
                <div>
                  ...
                  <h2 className="text-xl font-bold text-white mb-3 hover:text-red-500 transition duration-300">
                    <Link href={`/blog/${blog.id}`} prefetch={false}>{blog.title}</Link>
                  </h2>
