...
import { AEO_FAQS, getFAQSchema } from "@/data/seoConfig";
...
export default function FAQsPage() {
  ...
  return (
    <>
      <Head>
        <title>Elevator FAQs | Ask Amardeep Elevators Kadapa</title>
        <meta name="description" content="Get answers to frequently asked questions about lift installations, costs, home elevators, AMC charges, and maintenance services in Kadapa and Andhra Pradesh." />
        <meta name="keywords" content="elevator FAQs, lift cost Kadapa, home elevator maintenance, AMC charges lifts" />
        <link rel="canonical" href="https://amardipelevators.com/faqs" />
        ...
        <section className="px-6 py-16 md:px-10 lg:px-20 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {AEO_FAQS.map((faq, idx) => (
              <div key={idx} className="bg-neutral-900 rounded-3xl p-8 border border-neutral-800 hover:border-red-600/50 transition-all duration-300 shadow-lg">
          ...
          <div className="mt-16 bg-neutral-900 border border-neutral-800 p-8 rounded-3xl text-center">
            ...
            <p className="text-neutral-400 text-sm mb-6">Our engineering team is ready to answer any technical, structural, or pricing questions.</p>
            <a href="tel:+919247932351" className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full shadow-lg transition duration-300 inline-block">
              Ask an Expert Now
            </a>
          </div>
        </section>
