...
import { LOCATIONS_DATA, SERVICES_DATA, getLocalBusinessSchema, getBreadcrumbSchema } from "@/data/seoConfig";
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href={`https://amardipelevators.com/locations/${location.id}`} />
        <meta property="og:title" content={location.title} />
        <meta property="og:description" content={location.metaDescription} />
        <meta property="og:url" content={`https://amardipelevators.com/locations/${location.id}`} />
...
export function getStaticProps({ params }) {
  const location = LOCATIONS_DATA.find((item) => item.id === params.locationId);
